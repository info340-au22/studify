            ...
            <div className="mission-div">
                <h2 className="tag-for-mission">Studify's Story</h2>
                    <h4 className="h4-mission-tag"><em>Our Story</em></h4>
                        ...
                        <p className="mission-normal-text">Our goal is trying make an application that you the user have the perfect experience. We've discussed about how the app
                            in general are going to be look like, and final dicision is to have a custom schedule as well as have a space where you and your friends or new friends
                            can be learn together.</p>
                    ...
                    <h4 className="h4-mission-tag"><em>Our Mission</em></h4>
                        ...
                        <p className="mission-normal-text">Our mission is to make sure you have the perfect experience, and to make that happen we've included a few features 
